...
@Service
class Authentication @Autowired constructor(private val employeeRepository: EmployeeRepository) : AuthenticationService {
    override fun authenticate(employee: Employee): Boolean {
